...
const GRADING_RULES = [
  ...
  "- Mandatory cap: if the reply has no full content clause — for example, it is only a fragment, acknowledgment, or modal phrase such as `Good.` or `Yes, I can.` — cap each of grammar, spellingPunctuation, wordChoice, and collocation at 3, even when those aspects appear error-free; do not award 4 or 5 without a full content clause.",
  ...
  "- `modelReply` keeps the learner's content and intent, corrects it, and extends it only as far as needed to keep the conversation going, in one or two sentences at the same register. For a dead-end reply such as `Good.` or `Yes, I can.`, it must add one brief, natural follow-on sentence that gives the partner an opening. It is a repair of what they wrote, never a new answer of your own.",
