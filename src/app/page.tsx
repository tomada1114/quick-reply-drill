 ...
 *
 * The page's padding is a Tailwind utility rather than a rule in
 * `globals.css`, which is what makes `tests/server-smoke.test.ts`'s stylesheet
 * assertion a real check: it fetches the built CSS and looks for this class,
 * so a broken PostCSS pipeline fails the suite instead of rendering an
 * unstyled page nobody looks at.
 */
